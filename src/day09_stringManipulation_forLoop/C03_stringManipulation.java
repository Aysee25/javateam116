...
public class C03_stringManipulation {
    public static void main(String[] args) {
        ...
        // ilk harfi buyuk oldugu icin once hepsını buyuk harf yazıpıyoruz isim.toUpperCase().charAt(0)
        // sonra ılk harften sonrasını kucuk yap dıyoruz isim.substring(1).toLowerCase()
