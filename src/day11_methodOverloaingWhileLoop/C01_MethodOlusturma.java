package day11_methodOverloaingWhileLoop;

public class C01_MethodOlusturma {
    public static void main(String[] args) {
        // Soru 1- Kullanicidan input olarak verilen bir String'den,
    ...
    public static void substringYazdir(String metin, int basIndex, int bitisIndex){
        if (basIndex>bitisIndex){
            System.out.println("Baslangic index'i bitis index'inden buyuk olmaz");
        } else if (bitisIndex>(metin.length()-1)){
