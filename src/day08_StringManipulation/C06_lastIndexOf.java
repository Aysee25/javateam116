...
public class C06_lastIndexOf {
    public static void main(String[] args) {
        ...
        // bakmaya sondan baslayarak aratıyor
        ...
        System.out.println(str.indexOf("a")); // 1 == a'yı aramaya bastan baslar(ındex olarak)
        System.out.println(str.lastIndexOf("a")); //13 == a'yı aramaya sondan baslar(ındex olarak)
        ...
        // sondan da gelse bastan da gelse baslangıc ındex'ını kabul edıyor
